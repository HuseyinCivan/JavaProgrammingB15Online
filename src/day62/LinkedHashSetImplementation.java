...
//more job to do for linked hashSet slower than hashSet
//linked hashSet is subclass of hash set
//linked list is more specialized type of hashset it does keep the order
      ...
      Set<Integer> myNums = new LinkedHashSet<>();
        ...
        System.out.println("myNums LinkHashSet = " + myNums);
