...
//    * */
         ...
         int daysToWork=scan.nextInt();

         System.out.println("How many hours do you work in a day?");
         int hoursToWork=scan.nextInt();

         int secondsToWork= daysToWork*hoursToWork*60*60;

        System.out.println("You are working "+secondsToWork+" seconds in a week" );
