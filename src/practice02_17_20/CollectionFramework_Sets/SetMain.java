package practice02_17_20.CollectionFramework_Sets;
...
public class SetMain {
    ...
    public static void main(String[] args) {
        ...
        String[] arr={"Java","Python","C++","Javascript","Php"};
        ...
        System.out.println("*********HashSet*****************"); //rastgele siraladi
        for(String each : set1){
            System.out.println(each);
        }
        System.out.println("*********LinkedHashSet*****************");//ekledigimiz sirayla siraladi
        for(String each : set2){
            System.out.println(each);
        }
        System.out.println("*********TreeSet*****************");//alfabetik olarak siraladi
