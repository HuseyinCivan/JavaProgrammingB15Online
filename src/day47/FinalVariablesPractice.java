...
public class FinalVariablesPractice {
    ...
    public static void main(String[] args) {
       ...
       // s1=new Student(102);  // can not reassign the value. because it is final !!!


        //you can still chnge internal data attached to the object as long as it is the same object s1 pointing to
        //as long as the adress does not change
        //s1.studentId=200;---> yukardaki gibi object i final diye olustursanda studentid yi degistirebilirsin
        //s1.studentId=200; ----> student class da student id yi final yaparsan degistiremezsin!!
        System.out.println("s1.studentId = " + s1.studentId);
        System.out.println("Student.school = " + Student.SCHOOL);  //statik method la cagirdi
        //Student.school="abc";   // school statik oldugundan degistiremezsin !!
    ...
    /***
     * a method that accept a number and print out doubled number
     * @param x
     */
