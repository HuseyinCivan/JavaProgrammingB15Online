...
public class IteratingAnyCollection {
    public static void main(String[] args) {
        ...
        //using the Iterator instead of for each lopp / for loop /...
...
//        // next() --> will move  the pointer of itterator to the next element
//        System.out.println("myIter.next() = " + myIter.next());
//        System.out.println("myIter.next() = " + myIter.next());
//        System.out.println("myIter.next() = " + myIter.next());
//        System.out.println("myIter.next() = " + myIter.next());
...
//        System.out.println("nums = " + nums);
        ...
        // System.out.println("myIter.next() = " + myIter.next());  //NoSuchElementException
