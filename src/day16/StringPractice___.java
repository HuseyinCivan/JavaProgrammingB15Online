...
public class StringPractice___ {
...
//        System.out.println(fullName2.charAt(0)+fullName2.substring(fullName2.indexOf(" ")+1)+"@NightWatch.com");




//        String loveJava ="I really Love Java";
//        int firstSpace=loveJava.indexOf(" ");
//       // int secondSpace=loveJava.substring(firstSpace+1).indexOf(" ")+firstSpace+1;
//        int secondSpace=loveJava.indexOf(" ",firstSpace+1);
//        System.out.println(loveJava.substring(firstSpace+1,secondSpace));
